...
import operator
from DataModel.DecisionTree import tree_plotter
...
if __name__=='__main__':
    ...
    print('最好的特征索引：',choose_best_feature_to_split(data_set))