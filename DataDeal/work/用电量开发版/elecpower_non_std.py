...
def plotGraph(data):
    ...
    c = (
        Line(init_opts=opts.InitOpts(width="auto", height="auto"))
            ...
            .set_global_opts(title_opts=opts.TitleOpts(title="每天温度及加热变化(100表示开机；90表示加热)", pos_right="50%"),  # 设置标题
                             legend_opts=opts.LegendOpts(pos_bottom="7%"),  # 设置图例
